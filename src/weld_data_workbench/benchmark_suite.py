...
def _run_preview_benchmark(
    ...
    for sample_id in selected:
        ...
        elapsed, bundle = _timed(
            lambda sample_id=sample_id: generator.generate(sample_id, force=True)
        )
        cold.append(elapsed)
        cold_files += len(bundle.generated_files)
        elapsed, bundle = _timed(
            lambda sample_id=sample_id: generator.generate(sample_id, force=False)
        )
        warm.append(elapsed)
